  ...
  return (
    <div className={clsx(
      ...
      <div className="mx-auto relative w-full">
        ...
        {/* --- MAIN INPUT BOX --- */}
        <div className={clsx(
          "relative flex items-end bg-white dark:bg-[#212121] border border-slate-200 dark:border-slate-700 focus-within:ring-2 focus-within:ring-primary-100 dark:focus-within:ring-primary-900/30 transition-all rounded-2xl p-2 shadow-xl",
